            ...
            >
              <div className="p-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-50 to-green-50 dark:from-blue-900/20 dark:to-green-900/20">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  Works on localhost & any website
                </p>
              </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <div className="font-medium text-blue-900 dark:text-blue-100">How to Translate</div>
                      <div className="text-xs text-blue-600 dark:text-blue-300">Step-by-step instructions</div>
                    </div>
                  </div>
                </button>

                <div className="text-xs text-gray-500 dark:text-gray-400 mb-2 px-1">Or get instructions for specific language:</div>
