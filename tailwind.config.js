  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        // Kolkata patterns
        'kolkata-gradient': 'linear-gradient(135deg, #FFB800 0%, #C45C26 50%, #E23D28 100%)',
        'heritage-gradient': 'linear-gradient(135deg, #D4A015 0%, #8B7355 100%)',
        'tram-gradient': 'linear-gradient(90deg, #FFB800 0%, #D4A015 100%)',
        'durga-gradient': 'linear-gradient(135deg, #E23D28 0%, #FF4136 50%, #FFB800 100%)',
        'hooghly-gradient': 'linear-gradient(180deg, #1A5276 0%, #2D5A27 100%)',
      },
      boxShadow: {
        'tram': '0 8px 32px rgba(255, 184, 0, 0.3)',
        'terracotta': '0 8px 32px rgba(196, 92, 38, 0.3)',
        'heritage': '0 8px 32px rgba(139, 115, 85, 0.3)',
      },
    },
  },
  plugins: [],
